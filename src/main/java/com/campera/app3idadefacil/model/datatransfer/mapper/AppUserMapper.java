...
public class AppUserMapper {
    public static AppUserDto convertToDto(AppUser appUser){
        return new AppUserDto(appUser.getId(), appUser.getFirstName(), appUser.getLastName(), appUser.getEmail());
    }
    ...
    public static AppUser convertFromForm(AppUserForm form){
        ...
        return new AppUser(form.getFirstName(), form.getLastName(), form.getEmail(), hashedPassword);
    }
}
